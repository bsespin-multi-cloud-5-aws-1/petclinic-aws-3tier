...
d.svc("web-a", "mc-web-a (Apache 2.4)", "i-07a1229bd9fb4bb51 · t3.small · AL2023<br><b>index.html + /static/(9.6MB) = test 브랜치 WAR 소스 복사</b> · Apache 직접 서빙 · / 200<br>ProxyPass /petclinic/ → Internal ALB · Alias /images → /static/images · /health.html · CW Agent", "ec2", "compute", 670, 490, w=330, h=110)
d.svc("web-c", "mc-web-c (Apache 2.4)", "i-0e9f0a3f78f7bf7b2 · t3.small · 같은 user_data<br>SG mc-sg-web 80 ← sg-alb-public · SSM Online", "ec2", "compute", 1760, 490, w=310, h=110)
...
d.svc("was-a", "mc-was-a (Tomcat 9.0.121 · OpenJDK 8 · Green)", "i-0629cd519085394a3 · t3.medium<br>PetClinic <b>test</b>(Spring 5.3.39 · welcome.jsp mc-hero) · mvnw -P MySQL -Djdbc.url=Proxy(TLS) · systemd<br>CW Agent(/mc/was catalina·access·gc) · SG mc-sg-was 8080 ← sg-alb-internal", "ec2", "compute", 670, 670, w=340, h=120)
...
d.svc("was-c", "mc-was-c (Tomcat 9.0.121 · OpenJDK 8 · Green)", "i-0e8b6ee4c325856f2 · t3.medium<br>was.sh 보강(b8c5aa1): Proxy 로그인 성공까지 대기 후 기동", "ec2", "compute", 1760, 670, w=310, h=120)
