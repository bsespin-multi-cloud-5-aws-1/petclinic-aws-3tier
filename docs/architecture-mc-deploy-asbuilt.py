...
d.svc("web-a", "mc-web-a (Apache 2.4)", "i-060f7c40268620c41 · t3.small · AL2023<br><b>index.html + /static/(9.6MB) = test 브랜치 WAR 소스 복사</b> · Apache 직접 서빙 · / 200<br>ProxyPass /petclinic/ → Internal ALB · Alias /images → /static/images · /health.html · CW Agent", "ec2", "compute", 670, 490, w=330, h=110)
...
d.svc("was-a", "mc-was-a (Tomcat 9.0.121 · OpenJDK 8 · Green)", "i-082a98edcc9a8faf6 · t3.medium<br>PetClinic <b>test</b>(Spring 5.3.39) · mvnw -P MySQL -Djdbc.url=Proxy(TLS) · 사용자 <b>petclinic_app</b> · 풀 testOnBorrow · systemd<br>CW Agent(/mc/was catalina·access·gc) · SG mc-sg-was 8080 ← sg-alb-internal", "ec2", "compute", 670, 670, w=340, h=120)
...
d.svc("trail", "CloudTrail mc-trail (로깅 중)", "다중 리전 · 로그 파일 검증<br>→ S3 mc-cloudtrail-528821350786 (90일 IA · 1년)", "cloudtrail", "ops", 2200, 460, w=280, h=115)
d.svc("s3-logs", "S3 mc-logs-528821350786", "alb/public · alb/internal (ALB 액세스 로그 켜짐)<br>was/* · web/* · 90일/30일 만료", "simple_storage_service", "stor", 2495, 460, w=245, h=115)
...
d.text("legend", "■ 실선 = 요청 흐름 ①~⑥ · <span style='color:#D32F2F'>■ 붉은 실선 = DB 경로(RDS Proxy · TLS)</span> · ■ 점선 = 로그·알림·백업·비밀 · ■ 주황 점선 = 계층(EC2 고정 2대) · ■ 회색 점선 박스 = 미생성 선택 리소스  |  WAS = test 브랜치 Green(Spring 5.3.39 · Spring4Shell 패치 · welcome.jsp mc-hero) · Tomcat 9.0.121 · Corretto 8 — Blue(main · 9.0.53)로 복귀는 tfvars 2줄",
