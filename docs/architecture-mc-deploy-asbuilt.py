...
d.svc("cf", "CloudFront E2PWXW3LUYTDEE", "d2p7som2iuyba.cloudfront.net · PriceClass_200<br>Behavior: /static/* · /petclinic/resources/* · /petclinic/images/* 캐시(Hit 확인) · /maintenance.html S3 · * 동적<br>5xx → 503 점검 페이지 · 오리진 그룹 failover", "cloudfront", "net", 320, 340, w=210, h=140)
...
d.svc("web-a", "mc-web-a (Apache 2.4)", "i-06e44a36f0bb12633 · t3.small · AL2023<br><b>index.html + /static/(9.6MB) = test 브랜치 WAR 소스 복사</b> · Apache 직접 서빙 · / 200<br>ProxyPass /petclinic/ → Internal ALB · /health.html · CW Agent(/mc/web)", "ec2", "compute", 670, 490, w=330, h=110)
d.svc("web-c", "mc-web-c (Apache 2.4)", "i-0c35db73f414da70b · t3.small · 같은 user_data<br>SG mc-sg-web 80 ← sg-alb-public · SSM Online", "ec2", "compute", 1760, 490, w=310, h=110)
...
d.text("legend", "■ 실선 = 요청 흐름 ①~⑥ · <span style='color:#D32F2F'>■ 붉은 실선 = DB 경로(RDS Proxy · TLS)</span> · ■ 점선 = 로그·알림·백업·비밀 · ■ 주황 점선 = 계층(EC2 고정 2대) · ■ 회색 점선 박스 = 미생성 선택 리소스  |  Blue = main 브랜치(Spring 5.3.9 · Hibernate 5.5.6 · mysql-connector 8.0.19) · Tomcat 9.0.53 · Corretto 8",
