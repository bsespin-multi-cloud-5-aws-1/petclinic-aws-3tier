...
service("web-a", "WEB", "mc-web-a · Apache 2.4", "i-060f7c40268620c41<br>/ · /static/ 직접 · /petclinic/ 프록시", "ec2", "compute", 380, 935)
service("web-c", "WEB", "mc-web-c · Apache 2.4", "i-027f1785372b7bc8e<br>같은 user_data (web.sh)", "ec2", "compute", 1030, 935)
service("was-a", "WAS", "mc-was-a · Tomcat 9.0.121", "i-082a98edcc9a8faf6<br>mvnw -P MySQL · petclinic_app", "ec2", "compute", 380, 1180)
service("was-c", "WAS", "mc-was-c · Tomcat 9.0.121", "i-0a4022397a2e4889e<br>풀 testOnBorrow · systemd", "ec2", "compute", 1030, 1180)
